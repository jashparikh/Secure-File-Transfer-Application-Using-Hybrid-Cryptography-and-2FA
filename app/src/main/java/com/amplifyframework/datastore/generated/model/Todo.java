...
public final class Todo implements Model {
  ...
  public static final QueryField TEXT = field("Todo", "text");
  public static final QueryField USER_NAME = field("Todo", "userName");
  public static final QueryField TEST = field("Todo", "test");
  ...
  private final @ModelField(targetType="Boolean") Boolean test;
  public String getId() {
      return id;
  }
  ...
  private Todo(String id, String name, String description, String text, String userName, Boolean test) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), todo.getId()) &&
              ...
              ObjectsCompat.equals(getText(), todo.getText()) &&
              ObjectsCompat.equals(getUserName(), todo.getUserName()) &&
              ObjectsCompat.equals(getTest(), todo.getTest());
      }
  }
  ...
  public static class Builder implements NameStep, DescriptionStep, BuildStep {
    ...
    @Override
     public BuildStep test(Boolean test) {
        this.test = test;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, String text, String userName, Boolean test) {
      super.id(id);
      super.name(name)
    ...
    @Override
     public CopyOfBuilder test(Boolean test) {
